...
| :---: | :---: | :---: |
| ![인트로](screenshots/open_screenshot.png) | ![추천 탭](screenshots/maintap_screenshot.png) | ![내 옷 추천](screenshots/myrecommend_screenshot.png) |

| 04. 아카이브 클로젯 탭 | 05. OOTD 다이어리 일기장 탭 | 06. 마이 페이지 (친구 인터랙션) |
| :---: | :---: | :---: |
| ![클로젯 탭](screenshots/closet_screenshot.png) | ![OOTD 탭](screenshots/ootdtap_screenshot.png) | ![마이 페이지](screenshots/myfriendtap_screenshot.png) |
